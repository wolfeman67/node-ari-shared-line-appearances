 ...
 * @param {Client} opts.client - the ARI client instance
 * @param {Bridge} opts.bridge - the bridge that is being used by this extension
 * @param {Channel} opts.channel - the incoming channel object (inbound or
 *   outbound)
 * @param {Object} opts.data - the data relevant to this shared extension
 */

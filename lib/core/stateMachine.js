 ...
 * @param {Object} client - the asterisk client instance
 * @param {Object} data - the data (trunks, stations, etc.) related to this
 *   extension
 * @param {Object} channel - the incoming channel
 * @return {Object} stateMachine- the state machine related to this extension
 */
function create(client, data, channel) {
  ...
  var stateMachine = {
     ...
     * @param {Object} participant - the participant channel to be added
     */
     ...
     * @return {Boolean} - if participants is empty
     */
     ...
     * return {Boolean} - whether or not a channel is a station
     */
     ...
     * param {Object} participant - the participant channel
     */
     ...
     * param {Object} instance - the bridge instance returned from the module
     */
     ...
     * param {Object} participant - the participant channel that entered Stasis
     */
     ...
     * param {String} err - a error denoted by a string
     */
    exit: function(err) {
      var self = this;
     ...
     * param {Object} participant - the participant that entered Stasis
     */
     ...
     * param {Object} participant - the participant that hung up
     */
 ...
 * param {Object} client - the ARI client object
 * param {Object} data - the data related to the shared extension
 * param {Object} channel - the incoming channel
 * return {Object} - the state machine to be used
 */
